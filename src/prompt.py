...
Tool Usage:
    ...
    Use web search for film criticism, information supplementation, and contemporary analysis (e.g., "What did critics say about The Batman?" or "How did Everything Everywhere All at Once perform at the Oscars?").
"""
